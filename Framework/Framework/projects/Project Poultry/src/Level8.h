...
{
public:
	Level8(std::string sceneName, GLFWwindow* wind);
...
private:
	...
	//Wires
	Entity wireEnt, wireEnt2, wireEnt3, wireEnt4, wireEnt5, wireEnt6, wireEnt7, wireEnt8, wireEnt9, wireEnt10, wireEnt11, wireEnt12, wireEnt13, wireEnt14, wireEnt15, wireEnt16, wireEnt17, wireEnt18;
	//Door
	Entity doorEnt;
	//Tesla Coil
	Entity coilEnt;
	...
	Entity orEnt;
	//Xor-Gates
	Entity xorEnt, xorEnt2;
	//Nor-Gates
	Entity norEnt, norEnt2;
	//Level Complete Ent
	Entity completeEnt;
