...
#pragma endregion
	...
	Mesh wireM2("Models/Level2Wire2.obj", glm::vec3(1.0f, 0.0f, 0.0f));
	Mesh wireM3("Models/Level2Wire3.obj", glm::vec3(1.0f, 0.0f, 0.0f));
	Mesh wireM4("Models/Level2Wire4.obj", glm::vec3(1.0f, 0.0f, 0.0f));
	Mesh wireM5("Models/Level2Wire5.obj", glm::vec3(1.0f, 0.0f, 0.0f));
	Mesh wire1Power("Models/Level2Wire1.obj", glm::vec3(0.0f, 1.0f, 0.0f));
	Mesh wire2Power("Models/Level2Wire2.obj", glm::vec3(0.0f, 1.0f, 0.0f));
	Mesh wire3Power("Models/Level2Wire3.obj", glm::vec3(0.0f, 1.0f, 0.0f));
	Mesh wire4Power("Models/Level2Wire4.obj", glm::vec3(0.0f, 1.0f, 0.0f));
	Mesh wire5Power("Models/Level2Wire5.obj", glm::vec3(0.0f, 1.0f, 0.0f));
